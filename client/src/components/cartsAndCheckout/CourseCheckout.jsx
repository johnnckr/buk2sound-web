...
const shippingOptions = [
  { value: "rung_arun", label: "ຮຸ່ງອາລຸນ" },
  { value: "anusit", label: "ອານຸສິດ" },
  { value: "meesai", label: "ມີໄຊ" },
];
...
export default function CourseCheckOut() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // ส่ง shippingMethod ไป backend พร้อมข้อมูล order ได้ที่นี่
    // เช่น createOrder({ ..., shippingMethod })
  };
            ...
            <div className="col-lg-8">
              <div className="shopCheckout-form">
                ...
                >
                  ...
                  {/* เพิ่ม dropdown เลือกขนส่ง */}
                  <div className="col-12 mb-3">
                    <label className="text-16 lh-1 fw-500 text-dark-1 mb-10">
                      ເລືອກບໍລິສັດຂົນສົ່ງ (Shipping)
                    </label>
                    <select
